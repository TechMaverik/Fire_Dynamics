...
IGNITION_POINTS= Modify or add coordinates separated by comma to add custom ignition points.
FUEL_ADDITION_PROBABILITY= Add fuel probability set to 0 by default. Adjust the value to <=1.
